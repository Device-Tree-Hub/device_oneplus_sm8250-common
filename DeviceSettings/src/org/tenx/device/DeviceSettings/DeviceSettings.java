...
*
*/
package org.tenx.device.DeviceSettings;
...
import org.tenx.device.DeviceSettings.Services.VolumeService;
import org.tenx.device.DeviceSettings.Services.FPSInfoService;
import org.tenx.device.DeviceSettings.Utils.Utils;
import org.tenx.device.DeviceSettings.Utils.FileUtils;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
          if (preference == mMuteMedia) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.tenx.device.DeviceSettings.Services.HBMModeService.class);
            if (enabled) {
